            ...
            <FormContainer>
              <Form>
                ...
                <CheckBoxCon>
                  <input
                    type="checkbox"
                    id="Multi domain configuration"
                    value="Multi domain configuration"
                ...
                <CheckBoxCon>
                  <input
                    type="checkbox"
                    id="Drag - and - drop Page editor"
                    value="Drag - and - drop Page editor"
                    onChange={this.handleCheckboxChange}
                  />
            ...
            <FormContainer>
              <Form1>
                ...
                <CheckBoxCon>
                  <input
                    type="checkbox"
                    id="Social media Sharing functionality"
                    value="Social media Sharing functionality"
                    onChange={this.handleCheckboxChange}
                  />
