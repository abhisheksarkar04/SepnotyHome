      ...
      <Main className="form">
        <form onSubmit={this.handleSubmit}>
          ...
          <Main1>
            <FormContainer>
              <Form>
                <Heading>*Choose the type of you need:</Heading>
                <CheckBoxCon>
                  <Input
                    type="checkbox"
                    id="Corporate Website/App"
                    checked={typeOfWebsite.includes("Corporate Website/App")}
                ...
                <CheckBoxCon>
                  <Label htmlfor="Portfolio Website/App">
                    <Input
                      type="checkbox"
                      id="Portfolio Website/App"
                      checked={typeOfWebsite.includes("Portfolio Website/App")}
                      onChange={this.handleCheckboxChange}
                    />
                ...
                <CheckBoxCon>
                  <Label htmlfor="Digital Media Website/App">
                    <Input
                      type="checkbox"
                      id="Digital Media Website/App"
                      checked={typeOfWebsite.includes(
                ...
                <CheckBoxCon>
                  <Label htmlfor="Content aggregator">
                    <Input
                      ...
                      checked={typeOfWebsite.includes("Content aggregator")}
                      onChange={this.handleCheckboxChange}
                    />
                ...
                <CheckBoxCon>
                  <Input
                    type="checkbox"
                    id="6st"
                    checked={typeOfWebsite.includes("6st")}
                    onChange={this.handleCheckboxChange}
                  />
                  <Input1
                    type="text"
