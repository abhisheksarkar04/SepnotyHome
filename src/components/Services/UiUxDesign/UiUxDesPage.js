...
const DesignDetails = [
  ...
  },
  {
    ...
    title: "Wireframing",
    about:
      "Wireframing is one of the key parts of product design. Designers create a wireframe for each screen in the app and interconnect them to make a User Journey.After that, they turn the User Journey into a clickable prototype so that customers could experience their app and suggest adjustments if needed.",
    img: designimg2,
  },
  {
    id: 3,
...
const SubPageList = [
  {
    ...
    headingOne: "Purpose",
    aboutOne:
      "Wireframes serve as a blueprint for the final design, helping designers and stakeholders visualize the layout, content hierarchy, and functionality of a digital product before investing time and resources into detailed design and development.",
...
const UiUxDesPage = () => {
  ...
  const handleLearnMoreClick = (detail) => {
    const matchingSubPageDetail = SubPageList.find(
  ...
  return (
    <UiUxDesignPage>
      <WebPageTitle>
        Services &gt;<ServiceSpan>UI & UX Design</ServiceSpan>
      </WebPageTitle>
